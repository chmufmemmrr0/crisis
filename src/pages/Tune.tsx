...
export default function Tune() {
  ...
  if(flag)
  {
    ...
    setInterval(function(){
      lightsCounter++;
      if(lightsImg)
        lightsImg.setAttribute("src", "public/assets/lights_" + lightsCounter + ".svg");
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-slate-100 to-cyan-200 flex justify">
      <img src="public/assets/lights_1.svg" alt="lights" id="lights" className="absolute top-0 left-0 w-full block pointer-events-none select-none" />
      <img src="public/assets/snow.svg" alt="snow" className="z-1 absolute bottom-0 left-0 w-full block pointer-events-none select-none" />
      <Snow />
